        ...
        <div className="row d-flex align-items-end">
          <div className="col-8">
            ...
            <input
              type="text"
              class="form-control"
              placeholder={form.adult+" Người lớn, "+form.kid+" Trẻ em, "+form.room+" phòng"}
              onFocus={showForm}
            />
            <form id="hiddenForm">
              <div className="row">
                ...
                <div className="col-4">
                    <input type="number" placeholder="1" min="0" name="adult" onChange={onChangeForm}></input>
                </div>
              </div>
              <div className="row">
                <div className="col-8" >Trẻ em</div>
                <div className="col-4">
                    <input type="number" placeholder="0" min="0" name="kid" onChange={onChangeForm}></input>
                </div>
              </div>
              <div className="row">
                <div className="col-8">Phòng</div>
                <div className="col-4">
                    <input type="number" placeholder="1" min="0" name="room" onChange={onChangeForm}></input>
                </div>
              </div>
              <div className="row">
